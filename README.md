# Flask Login Service Backend

A stateless, demonstration-ready RESTful authentication API built with Flask and JWT. This backend provides foundational, standards-driven login and profile endpoints with hardcoded user data for easy prototyping, internal tools, hackathons, or frontend integration testing.
